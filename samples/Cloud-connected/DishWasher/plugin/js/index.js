...
var ocfDevice;
var className = "DishWasher";
var capabilities = [capabilitySwitch, capabilityDishwasherMode, capabilityDishwasherOperatingState, capabilityEnergyMeter];
...
function OnSetStateClicked() {
	capabilityDishwasherOperatingState.setState();
}

function onCancelClicked() {
	capabilityDishwasherOperatingState.set("stop");
}
